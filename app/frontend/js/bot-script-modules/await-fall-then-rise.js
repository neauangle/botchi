...
export const NAME = "AwaitFallThenRise";
...
export function getInstance(customParameters){
    return AwaitRiseThenFallOrFallThenRiseBase.getInstance(AwaitRiseThenFallOrFallThenRiseBase.TYPE.AWAIT_FALL_THEN_RISE, customParameters);
}
...
export function getDefaultParameters(){
    return AwaitRiseThenFallOrFallThenRiseBase.getDefaultParameters(AwaitRiseThenFallOrFallThenRiseBase.TYPE.AWAIT_FALL_THEN_RISE);
}

export function handleTrackerChanged(parameters, extraInfo){
    return AwaitRiseThenFallOrFallThenRiseBase.handleTrackerChanged(AwaitRiseThenFallOrFallThenRiseBase.TYPE.AWAIT_FALL_THEN_RISE, parameters, extraInfo);
}
